...
def launch(context, *args, **kwargs):
    ...
    launch_processes = []
    xacro_file = robot_urdf
    if xacro_file == '':
        xacro_file = os.path.join(
                # get_package_share_directory('bbasv_gazebo_plugins'),
                # "robots/asv4.xacro")
            get_package_share_directory('asv4_description'),
            "urdf/bbasv4.urdf.xacro")
    ...
    if config_file and config_file != '':
        ...
        m = Model('asv4', 'wam-v', [-532, 162, 0, 0, 0, 1])
